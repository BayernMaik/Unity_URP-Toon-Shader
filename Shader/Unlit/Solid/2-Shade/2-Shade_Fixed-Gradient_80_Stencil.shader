Shader "Toon/Unlit/Solid/2-Shade/2-Shade_Fixed-Gradient_80_Stencil"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        CBUFFER_END
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                Gradient _Gradient_ea82d1704a1442c0afad2bc9bdf82fbe_Out_0 = NewGradient(1, 3, 2, float4(0.2, 0.2, 0.2, 0.3323568),float4(0.6, 0.6, 0.6, 0.6647135),float4(1, 1, 1, 1),float4(0, 0, 0, 0),float4(0, 0, 0, 0),float4(0, 0, 0, 0),float4(0, 0, 0, 0),float4(0, 0, 0, 0), float2(1, 0),float2(1, 1),float2(0, 0),float2(0, 0),float2(0, 0),float2(0, 0),float2(0, 0),float2(0, 0));
